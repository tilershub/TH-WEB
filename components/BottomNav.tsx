...
function NavItem({ href, label, active, children }: NavItemProps) {
  return (
    <Link
      ...
      className={`flex flex-col items-center justify-center min-w-[64px] py-2 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-lg ${
